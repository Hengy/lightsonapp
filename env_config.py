...
QUEUE_MAX = 3           # max number of users in the queue; if full, user will be asked to try again later
QUEUE_MAX_TIME = 30     # time (in seconds) a user has to control LEDs before control is passed to next in queue

#------------------------------------------------------
# TIME ON/OFF
#------------------------------------------------------

TIME_ON = 14        # hour to turn on (24 hour time) 17 = 5PM
